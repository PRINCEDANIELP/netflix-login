...
export default function handler(req, res) {
  ...
  return res.status(201).json({ success: true, message: 'Registration successful', user: { id: newUser.id, email: newUser.email, name: newUser.name }, token: generateMockToken(newUser.id) });
}
